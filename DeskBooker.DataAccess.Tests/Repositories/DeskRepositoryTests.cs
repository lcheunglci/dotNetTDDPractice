    ...
    public class DeskRepositoryTests
    {
        ...
        public void ShouldReturnTheAvailableDesks()
        {
            ...
            using (var context = new DeskBookerContext(options))
            {
                ...
                context.DeskBooking.Add(new DeskBooking { DeskId = 1, Date = date, Email = "test@test.com", FirstName = "John", LastName = "Doe" });
                context.DeskBooking.Add(new DeskBooking { DeskId = 2, Date = date.AddDays(1), Email = "test2@test.com", FirstName = "Bob", LastName = "Smith" });
