...
namespace DeskBooker.Core.Processor
{
    public class DeskBookingRequestProcessorTests
    {
        ...
        public DeskBookingRequestProcessorTests()
        {
            ...
            _deskRepositoryMock.Setup(x => x.GetAvailableDesks(_request.Date)).Returns(_availableDesk);
        ...
        public void ShouldSaveDeskBooking()
        {
            ...
            _deskBookingRepositoryMock.Setup(x => x.Save(It.IsAny<DeskBooking>())).Callback<DeskBooking>(deskbooking => savedDeskBooking = deskbooking);
        ...
        public void ShouldReturnDeskBookingId(int? expectedDeskBookingId, bool isDeskAvailable)
        {
            if (!isDeskAvailable)
            {
                _availableDesk.Clear();
